...
# Line 1:
SOIL_SITE_S = 'A11,1X,A5,1X,F5.0,1X,A50'

# Line 2:
SOL_SECOND_LINE_V = '2(1X,A11),2(1X,A8),1X,A50'
SOL_SECOND_LINE_L = '2(1X,A11),2(1X,F9.3),1X,A50'
...
SOL_NL_TO_4NL_FIRST_LINE_V = '17(1X,A5)'
SOL_NL_TO_4NL_FIRST_LINE_L = '1X,F5.0,16(1X,F5.1)'
