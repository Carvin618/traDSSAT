...
class PeriphWeatherMgr(PeriphFileMgr):
    ...
    def set_value(self, var, val, level, sect=None, subsect=None, cond=None):
        self.files[level].set_value(var, val, sect=sect, subsect=subsect, cond=cond)
...
class WeatherFileMgr(object):
    ...
    def write(self, force=False):
        self.file.write(self.path, force)
