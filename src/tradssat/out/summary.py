...
_vars = {
    ...
    CharacterVar('MODEL', 8, fill='.', info='DSSAT crop model used'),
    CharacterVar('EXNAME', 8, fill='.', info='Experiment file name'),
    CharacterVar('TNAM', 25, fill='.', info='Treatment name'),
    CharacterVar('FNAM', 8, fill='.', info='Field name'),
    CharacterVar('WSTA', 8, fill='.', info='Weather station name'),
    CharacterVar('SOIL_ID', 10, fill='.', info='Soil name'),
